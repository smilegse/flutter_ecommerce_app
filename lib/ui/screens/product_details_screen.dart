                                        ...
                                        GetBuilder<WishListController>(builder: (wishListController) {
                                          ...
                                          return SizedBox(
                                            ...
                                            child: ElevatedButton(
                                              ...
                                              onPressed: () async {
                                                log('Log productId: ${productDetails.productId.toString()}');
                                                  ...
                                                  Get.find<WishListController>().addToWishlist(productDetails.productId!)
                                                      .then((value) => {
                                                          if (value)
                                                            {
                                                              const GetSnackBar(
                                                                title:'Wish List Notification',
                                                                message: 'Product has been added into wish list',
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          '৳${formatter.format(double.parse(_totalPrice))}',
                          style: const TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.w500,
                            color: primaryColor,
